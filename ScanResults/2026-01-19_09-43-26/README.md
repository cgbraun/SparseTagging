...
**Scan Date:** 2026-01-19 09:43:26 UTC
**Commit SHA:** d5a3254fe149fd5e473364349d50b215cefb7736
**Branch:** main
**Workflow Run:** https://github.com/cgbraun/SparseTagging/actions/runs/21132453173
...
- 📊 [Full Workflow Run](https://github.com/cgbraun/SparseTagging/actions/runs/21132453173)
...
> **📋 Documented Vulnerabilities:** 2 HIGH severity CVEs are documented as accepted risks with low practical exploitability:
...
**Total:** 2 HIGH severity CVEs documented with accepted risk
...
**Next Steps:**
- Review [workflow run logs](https://github.com/cgbraun/SparseTagging/actions/runs/21132453173) for full execution details
- Check `SECURITY.md` in repository root for security policy and reporting procedures

---

_Report generated by CI/CD pipeline on 2026-01-19 09:43:26 UTC - See [full workflow run](https://github.com/cgbraun/SparseTagging/actions/runs/21132453173)_