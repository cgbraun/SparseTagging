...
**Scan Date:** 2026-01-24 20:31:35 UTC
**Commit SHA:** f27fca65166a93bfff18ab99a9f2c9115a60d1ba
**Branch:** main
**Workflow Run:** https://github.com/cgbraun/SparseTagging/actions/runs/21321140521
...
- 📊 [Full Workflow Run](https://github.com/cgbraun/SparseTagging/actions/runs/21321140521)
...
**Next Steps:**
- Review [workflow run logs](https://github.com/cgbraun/SparseTagging/actions/runs/21321140521) for full execution details
- Check `SECURITY.md` in repository root for security policy and reporting procedures

---

_Report generated by CI/CD pipeline on 2026-01-24 20:31:35 UTC - See [full workflow run](https://github.com/cgbraun/SparseTagging/actions/runs/21321140521)_